...
public final class Condition {
    ...
    static {
        ...
        stringMatchers.put(PredicateType.ENDS_WITH, (target, objects) -> Objects.nonNull(target) && objects.stream().anyMatch(target::endsWith));
        ...
        stringMatchers.put(PredicateType.CONTAINS, (target, objects) ->  Objects.nonNull(target) && objects.stream().anyMatch(target::contains));
        stringMatchers.put(PredicateType.MATCHES_REGEX,
                (target, objects) -> objects.stream().anyMatch(s ->  Objects.nonNull(target) && Pattern.compile(s).matcher(target).find()));
        ...
        stringMatchers.put(PredicateType.DOES_NOT_MATCH_REGEX,
                (target, objects) ->  Objects.nonNull(target) && objects.stream().noneMatch(s -> Pattern.compile(s).matcher(target).find()));
